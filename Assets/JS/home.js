  ...
  fetchData(
    ...
    function (data) {
      ...
      for (let i = 0; i < 12; i++) {
        ...
        const isSaved = window.localStorage.getItem(`CookBook-Recipe${recipeId}`);
        ...
        $card.innerHTML = `
          ...
          title ?? "Untitled"
                ...
                <div class="meta-wrapper">
                    ...
                    }" aria-label="Add to saved recipes" onclick="savedRecipe(this, '${recipeId}')">
...
let cuisineType = ["Italian", "Mexican"];
...
for (const [index, $sliderSection] of $sliderSections.entries()) {
  ...
  <div class="container">
    <h2 class="section-title headline headline-small" id="slider-label-1">Latest ${
      cuisineType[index]
    } Recipes</h2>

    <button class="slider-next-btn" type="button" id="slider-next-btn"><span class="material-symbols-outlined">
    navigate_next
    </span></button>
    <button class="slider-prev-btn" type="button" id="slider-prev-btn"><span class="material-symbols-outlined">
    navigate_before
    </span></button>
  ...
  fetchData(
    ...
    <li class="slider-item" data-slider-item>
        <a href="./recipes.html?cuisineType=${cuisineType[index]}" class="load-more-card has-state">
...
const buttonRight = document.getElementsByClassName("slider-next-btn");
const buttonLeft = document.getElementsByClassName("slider-prev-btn");
const slide = document.getElementsByClassName("slider");

buttonRight[0].onclick = function () {
  slide[0].scrollLeft += 200;
};
